...
Santa's reindeer typically eat regular reinder food, but they need a lot
of (magical energy)[https://adventofcode.com/2018/day/25] to deliver presents on Christmas. For that, their
favorite snack us a soecial type of **star** fruit that only grows deep in the
...
grove has plenty of fruit, you decide to grab fruit you see along the
way, just in case.
...
The Elves take turns writing down the number of Calories container by the
...
The list represents the Calories of the food carried by five Elves:
...
Elf carryinf the **most** Calories. In the example above, this is `24000`
(carried by the fourht Elf).
