[Day 19. Not Enought Minerals.](https://adventofcode.com/2022/day/19)

Your scans show that the lava did indeed form obsidian!

The wind has changed direction enought to stop sending lava droplets toward
...
obisidian-collecting robots. Fortunately, there is an abundant amount of
...
Each robot can collect 1 of its resources type per minute. It also takes one
minute for the robot factory (also conveniently from your pack) to
construct any type of robot, although it consumes the necesaary resources
available when contruction begins.

The robot factory has many blueprints (your puzzle input) you can choose
from, but once you've condigured it with a blueprint, you can't change it.
...
in 24 minutesusing the blueprint. In this example, the first blueprint
...
geode it could produce in 24 minutes. What do you get if you add up the
