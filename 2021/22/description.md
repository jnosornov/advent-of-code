...
The reactor core is made up of a large 3-dimesional grid made up entirely
...
off. (Could it be an old model of a reactor you've seen [before](https://adventofcode.com/2020/day/17)?)
...
cubes that have coordinates which fall within ranges for x, y, z) and whether
