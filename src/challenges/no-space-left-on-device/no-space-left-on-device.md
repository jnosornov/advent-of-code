...
proceeds. Ocasionally, you can even hear mouch loader sounds in the
...
Perhaps you can delete some files to make for the update?

You browse around the filesystem to assets the situation and save the
...
The filesystem consists of a tree of files (plain data) and directiores
...
- `cd` means change directory. This changes which directoy is the current
...
- `ls` means list. It prints out all of the files and directories
  inmmediately contained by the current directory.
...
- The directory `a` has a total size 94853 because it contains files `f` (size
...
then calculate the sum of their total sizes. In the example, these
