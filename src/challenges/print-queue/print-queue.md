...
Satified with their search on Ceres, the squadron of scholars suggests
subsequently scanning the stationary stacks of sub-basement 17.
...
page number `53`. (`47` doesn't necessarily need to be inmediately before 53;
...
To get the printers going as soon as possible, start by identifyng which
...
- 47 is correctly second because 75 must be before it 75|74 and every
other page must be after it according to 47|61, 47|53, and 47|29.
- 61 is corretly in the middle because 75 and 47 are before it (75|61
and 47|61) and 53 and 29 are after it (61|53 and 61|29).
- 53 is correctly fourth because it is before page number 29 (53|29).
- 29 is the only page left and so correctly last.
...
The fifth update, 61, 12, 29, is also not in the correct order, since it
...
each correctly update. In the above example, the correctly-ordered
updates are:
