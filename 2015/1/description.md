...
by starts, and he's fresh out!, To save Christmas, he needs you to collect fiifty starts by
December 25th.

Collect starts by helping Santa solve puzzles. Two puzzles will be made avaialable on each day
...
and then follow the instructions at a time.

An opening parrenthesis, (, means he should go up one floor, and a closing parenthesis, ), means
...
- ((( abd (()(()( both result in floor 3
- ))((((( also results in floor 3
- ()) and ))( both result in floor -1 (the first basement level)
- ))) abd )())()) both result in floor -3

To what floor do the instructions taje Santa?
...
- ()()) causes him to enter basement at character position 5
